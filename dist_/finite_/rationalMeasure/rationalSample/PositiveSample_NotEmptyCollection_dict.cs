...
{
	public class PositiveSample_NotEmptyCollection_dict
		:PositiveSample_NotEmptyCollection<nilnul.num.rational.Rational_InheritFraction>
	
	{

		public PositiveSample_NotEmptyCollection_dict(NotNull2<NonEmptyEnumerable<SampleCountPositive>> samples)
