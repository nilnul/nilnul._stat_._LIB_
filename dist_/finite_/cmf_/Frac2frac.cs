...
namespace nilnul.stat.dist_.finite_.cmf_
{
	...
	public class Frac2frac :
		nilnul.obj.Box_pub<SortedDictionary<nilnul.num.Quotient1, Prob8frac>>
		,

		ICmfable
	{
		public Frac2frac(SortedDictionary<nilnul.num.Quotient1, Prob8frac> val) : base(val)
		{
		...
		public Prob8frac cumulativeDensity(nilnul.num.Quotient1 el) {
