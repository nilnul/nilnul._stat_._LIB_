...
namespace nilnul.prob.rationalMeasure.empirical
{
	...
	/// 
	/// </summary>
	public partial class EmpiricalDistribution2
	{
		...
		public Rational_InheritFraction density(Rational_InheritFraction sample)
		{
			...
			var interval = nilnul.interval.BinarySearchX.BinarySearchX_ListBiSearch_index<Rational_InheritFraction>(
					(sample),
					benchmarkOfDensities.Select(c => c.probabilityNotNull).Cast<Rational_InheritFraction>().ToList(),
			...
			return benchmarkOfDensities[interval.Item2.Value].probability.val as Rational_InheritFraction / ( benchmarkOfDensities[interval.Item2.Value].sample-benchmarkOfDensities[interval.Item1.Value].sample);
