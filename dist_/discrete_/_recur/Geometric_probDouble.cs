...
namespace nilnul.prob._recur
{
	...
	/// </remarks>
	public partial class Geometric_probDouble
	{


		private double _p;

		public Geometric_probDouble(double p) {
			if (p<0 || p>1)
			{
				throw new Exception();
			}
		...
		static public Geometric_probDouble CreateHalfHalf() {
			return new Geometric_probDouble(.5);
		}
