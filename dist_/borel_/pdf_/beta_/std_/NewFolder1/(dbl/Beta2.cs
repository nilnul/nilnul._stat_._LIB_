...
namespace nilnul.prob.doubleProb.doubleSample.cdf.contains
{
		...
		:DistributionA
	{
		...
		public override Prob probability(double  upperBound)
		{
			...
			return new Prob( nilnul.math.calculus.RegularizedIncompleteBetaFunction.Eval(a, b, upperBound));
		}

		public override double inverse(Prob prob)
		{
			return nilnul.math.calculus.RegularizedIncompleteBetaFunction.Inverse( a, b,prob._val);
		}
	}
}
