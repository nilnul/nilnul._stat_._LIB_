...
namespace nilnul.prob_.fininte.gen_.boundSum_
{
	...
	public class RandomizeThenNormalize
	{
		...
		static public double[] Exe(
			int countOfItems_positive, double sumTarget_nonNeg, double bound
		)
		{
		...
		static public int[] Exe_ceilingByDistribution(
			int countOfItems_positive, int sumTarget_nonNeg, int bound_nonNeg
		) {
