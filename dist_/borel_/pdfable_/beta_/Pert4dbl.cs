...
namespace nilnul.stat.dist_.borel_.pdfable_.beta_
{
		...
		borel_.Pert4dblI
	{
		...
		public nilnul.stat.dist_.borel_.pdfable_.Beta4dbl toBetaGeneralizedDist
		{
			get
			{
				return new nilnul.stat.dist_.borel_.pdfable_.Beta4dbl(a, b, min, _max);
			}
		...
		public override double cumulatedProb(double x)
		{
		...
		static public dist_.borel_.pdfable_.Beta4dblI ToBetaGeneralized(double min, double mod, double max, double lambda = 4)
		{
		...
		public override double prob(Bound4dbl sample)
		{
