...
namespace nilnul.stat.dist_.borel_._beta.generalized_
{
	public class Pert
	{
		...
		public nilnul.stat.dist_.borel_.beta_.Spanned4dbl toBetaGeneralizedDist
		{
			get
			{
				return new nilnul.stat.dist_.borel_.beta_.Spanned4dbl (a, b, min, max);
			}
		...
		static public dist_.borel_.beta_.Spanned4dbl ToBetaGeneralized(double min, double mod, double max, double lambda = 4)
		{
